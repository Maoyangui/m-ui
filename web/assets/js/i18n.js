...
const zh = {
  ...
  'cert.usePanel': '面板', 'cert.useSub': '订阅', 'cert.selfsign': '生成自签证书', 'cert.hosts': '域名 / IP(逗号分隔)', 'cert.hostsHelp': '自签证书客户端需关闭证书校验(allow-insecure),仅测试或纯 IP 场景使用',
...
const en = {
  ...
  'cert.usePanel': 'Panel', 'cert.useSub': 'Subscription', 'cert.selfsign': 'Generate self-signed', 'cert.hosts': 'Domains / IPs (comma separated)', 'cert.hostsHelp': 'Clients must disable certificate verification (allow-insecure); for testing or IP-only setups',
